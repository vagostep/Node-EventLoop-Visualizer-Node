...
function processTicksAndRejections() {
  let tock;
  do {
    fs.writeFileSync(1, `[ticksAndRejections] Phase: 'NextTick'\n`, { flag: "a" });
    ...
    fs.writeFileSync(1, `[ticksAndRejections] Phase: 'MicroTasks'\n`, { flag: "a" });
    runMicrotasks();
  } while (!queue.isEmpty() || processPromiseRejections());
  setHasTickScheduled(false);
  setHasRejectionToWarn(false);
  fs.writeFileSync(1, `[ticksAndRejections] Phase: 'EndProcessTicksAndRejections'\n`, { flag: "a" });
}
