...
function processTicksAndRejections() {
  fs.writeFileSync(
    1,
    `[ticksAndRejections] Phase: 'TicksAndRejectionsStart'\n`,
    {
      flag: 'a',
    }
  );
  ...
  do {
    fs.writeFileSync(
      1,
      `[ticksAndRejections] Phase: 'TicksAndRejectionsNextTick'\n`,
      { flag: 'a' }
    );
    ...
    fs.writeFileSync(
      1,
      `[ticksAndRejections] Phase: 'TicksAndRejectionsMicroTasks'\n`,
      { flag: 'a' }
    );
    runMicrotasks();
  ...
  fs.writeFileSync(
    1,
    `[ticksAndRejections] Phase: 'TicksAndRejectionsFinish'\n`,
    { flag: 'a' }
  );
}
